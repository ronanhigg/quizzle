...
class Upload_Video
{
    ...
    {
        //throw new Upload_VideoException('Fake error to see if rollback is working...');
    ...
    public function delete_file($file_path)
    {
        ...
        if ( ! $is_uploaded_file_removed) {
            throw new Upload_VideoException('Could not remove uploaded file from local server.');
        }
    }
}
