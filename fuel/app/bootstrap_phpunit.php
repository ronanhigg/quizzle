...
/* DRAGON - This file has been copied to the app directory so it can be safely
            edited. The assignments to $_SERVER below are to replicate the
            values that would have been in the phpunit.xml config, but that are
            not properly assigned when process isolation is set.
            -- Conor
*/
$_SERVER['doc_root'] = "../../";
